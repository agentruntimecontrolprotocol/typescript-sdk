...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="mcp-skill-dark.svg">
  <img alt="ARCP recipe diagram (worked example)" src="mcp-skill-light.svg">
</picture>
...
[`mcp-skill-light.dot`](mcp-skill-light.dot) / [`mcp-skill-dark.dot`](mcp-skill-dark.dot).
...
| `mcp-skill-light.dot` / `mcp-skill-dark.dot` | Worked example shown above.                             |
