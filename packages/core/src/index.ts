// Public surface of @agentruntimecontrolprotocol/core — shared primitives consumed by @agentruntimecontrolprotocol/client
// and @agentruntimecontrolprotocol/runtime. See ARCP v1.1 for the protocol spec.
